...
function AddPost({ id, dataFunction, setTheClick }) {
  ...
  return (
    <article className='main-form post' style={{ borderBottom: "1px dashed gray", paddingBottom: "2rem" }}>
      <form style={{ alignItems: "center", border: "1px solid whitesmoke", padding: "1rem", borderRadius: "10px" }} className="register-form">
        ...
        <div className='input-container'>
          ...
          <textarea className='input' onChange={handleChange} name="description" cols="30" rows="5" value={description}></textarea>
        </div>
